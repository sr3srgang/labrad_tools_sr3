...
class MyClient(SmartValuesClient):
    ...
    lat_h = ['sequencer.lat_h_high',
             'sequencer.lat_h_low', 'sequencer.lat_h_ramp']
    ...
    clock_params = ['sequencer.clock_int_pi', 'sequencer.t_pi']
    defaults = [('lattice', lat_params), ('clock', clock_params),
                ('cavity', cav_params), ('other', ['sequencer.bLoad'])]

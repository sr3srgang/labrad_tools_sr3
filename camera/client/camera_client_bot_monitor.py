...
class CameraGui(QDialog):
    ...
    def save_vals(self):
        ...
        filename = r"C:\Users\srgang\labrad_tools\camera\client\Bot_Monitor_Historical_Markers.txt"
    ...
    def load_vals(self):
        filename = 'C:/Users/srgang/labrad_tools/camera/client/Bot_Monitor_Historical_Markers.txt'

...
class CavityPico(Picoscope):
	...
	picoscope_timeout =10000
	picoscope_duration =175e-3#2e-3#40e-3
	picoscope_sampling_interval = 48e-9#16e-9#16e-9#16e-9#25e-6#16e-9
...
#	picoscope_resolution = 12   #8, 12, 13, 14, 15, 16
	...
	data_format = {'A': ['gnd']} #'exc':1}}#'test_new_trig': 1

...
class CavityPico(Picoscope):
	...
	picoscope_timeout =5000#0
	picoscope_duration =20e-3#2e-3#40e-3
	picoscope_sampling_interval = 32e-9#16e-9#16e-9#25e-6#16e-9
	picoscope_n_capture = 2#3
#	picoscope_resolution = 12   #8, 12, 13, 14, 15, 16
	...
	data_format = {'A': ['gnd', 'exc']}#'exc':1}}#'test_new_trig': 1

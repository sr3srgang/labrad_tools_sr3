...
#        ps2.close()
    ...
    @setting(13, channel='s', coupling='s', voltage_range='v', attenuation='i', enabled='b')
    ...
    @setting(14, duration='v', frequency='v')
    ...
    @setting(15, source='s', threshold='v', timeout='i')

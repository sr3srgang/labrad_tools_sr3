...
SEP = os.path.sep
sequences_path = "/home/srgang/H/data/scripts/20240423/run_me/sequences.py"
seq = imp.load_source("sequences.py", sequences_path)
...
class SequencerClient(QtGui.QWidget):
    ...
    def __init__(self, reactor, cxn=None):
        ...
        self.cxn = cxn
        self.test_sequence = seq.coherent_readout
        self.connect()

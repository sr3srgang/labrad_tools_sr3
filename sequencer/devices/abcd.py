...
class ABCD(YeSrDigitalBoard):
    ...
    channels = [
        ...
        YeSrDigitalChannel(loc=['B', 7], name='B7', mode='auto', manual_output=False, invert=False),
        YeSrDigitalChannel(loc=['B', 8], name='B8', mode='auto', manual_output=False, invert=False),
        YeSrDigitalChannel(loc=['B', 9], name='B9', mode='auto', manual_output=False, invert=False),
        YeSrDigitalChannel(loc=['B', 10], name='B10', mode='auto', manual_output=False, invert=False),
        YeSrDigitalChannel(loc=['B', 11], name='B11', mode='auto', manual_output=False, invert=False),
        YeSrDigitalChannel(loc=['B', 12], name='B12', mode='auto', manual_output=False, invert=False),
        YeSrDigitalChannel(loc=['B', 13], name='B13', mode='auto', manual_output=False, invert=False),
        ...
        YeSrDigitalChannel(loc=['D', 5], name='D5', mode='auto', manual_output=False, invert=False),
        YeSrDigitalChannel(loc=['D', 6], name='D6', mode='auto', manual_output=False, invert=False),
        YeSrDigitalChannel(loc=['D', 7], name='D7', mode='auto', manual_output=False, invert=False),
